...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>">
  ...
  <body<?php print $body_class ?>>
	...
	<div id="menu_admin">
		<?php print str_replace('href="/"', 'href="/" target="_blank"', $menu)  ?>
		<p class="dados-usuario"><?php global $user;  print "Olá " .  $user->name . "  <a href='" .base_path() . "user/". $user->uid."/edit'>Editar meus dados</a>";?></p>
	</div>
...
<!-- 		  <?php if ((arg(0) == 'admin' AND (arg(2))) || $admin_left) { ?>
    ...
    <?php if ( (arg(2) == 'pontos-google-maps') || (arg(0)=='node' && arg(2) == 'edit')): ?>
